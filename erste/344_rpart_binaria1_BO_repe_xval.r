...
# trabaja con la clase binaria1
#  POS={BAJA+2}  NEG={BAJA+1, CONTINUA}
...
PARAM <- list()
PARAM$home <- "/home/vbettachini/documents/universitet/FCEyN/maestríaDatos/economíaFinanzas/dmeyf2023/meine/"
...
) # inserté mis 5 semillas como las primeras
...
loguear <- function(reg,
arch = NA,
folder = "./componentesLista/",
ext = ".txt",
verbose = TRUE
) {
  archivo <- arch

...
PARAM <- list()
PARAM$experimento <- "KA8240_20231014_01"
...
PARAM$finalmodel$optim$num_iterations <- 512
PARAM$finalmodel$optim$learning_rate <-  0.117781	
PARAM$finalmodel$optim$feature_fraction <- 0.351834	
PARAM$finalmodel$optim$min_data_in_leaf <- 3390
PARAM$finalmodel$optim$num_leaves <- 644

...
PARAM$experimento <- "dritte823_1126panic"
...
PARAM$trainingstrategy$semilla_azar <- 874807 # TERCER semilla
...
PARAM$lgb_semilla <- 674831 # CUARTA semilla
...
PARAM$bo_lgb <- makeParamSet(
  ...
  makeNumericParam("feature_fraction", lower = 0.05, upper = 0.85),
  makeIntegerParam("num_leaves", lower = 256L, upper = 4096L),

...
PARAM <- list()
PARAM$experimento <- "dritte824_1128kp"
...
for (i in 1:length(semillerio)) {
  ...
  PARAM$finalmodel$optim$learning_rate <- 0.0107542630090029
  PARAM$finalmodel$optim$feature_fraction <- 0.121644434861955
  PARAM$finalmodel$optim$num_leaves <- 3446

...
### Descargo resultados de corrida de `824_1122.r`
Genero el comando seleccionadndo los arhcivos de raiz `prediccion` en [bucket dritte824_1122](https://console.cloud.google.com/storage/browser/normanbuck/exp/dritte824_1222;tab=objects?project=dmeyf2023&prefix=&forceOnObjectsSortingFiltering=false)


```{bash}
gsutil -m cp \
  "gs://normanbuck/exp/dritte824_1222/prediccion_1.txt" \
  "gs://normanbuck/exp/dritte824_1222/prediccion_10.txt" \
  "gs://normanbuck/exp/dritte824_1222/prediccion_11.txt" \
  "gs://normanbuck/exp/dritte824_1222/prediccion_12.txt" \
  "gs://normanbuck/exp/dritte824_1222/prediccion_13.txt" \
  "gs://normanbuck/exp/dritte824_1222/prediccion_14.txt" \
  "gs://normanbuck/exp/dritte824_1222/prediccion_15.txt" \
  "gs://normanbuck/exp/dritte824_1222/prediccion_16.txt" \
  "gs://normanbuck/exp/dritte824_1222/prediccion_17.txt" \
  "gs://normanbuck/exp/dritte824_1222/prediccion_18.txt" \
  "gs://normanbuck/exp/dritte824_1222/prediccion_2.txt" \
  "gs://normanbuck/exp/dritte824_1222/prediccion_3.txt" \
  "gs://normanbuck/exp/dritte824_1222/prediccion_4.txt" \
  "gs://normanbuck/exp/dritte824_1222/prediccion_5.txt" \
  "gs://normanbuck/exp/dritte824_1222/prediccion_6.txt" \
  "gs://normanbuck/exp/dritte824_1222/prediccion_7.txt" \
  "gs://normanbuck/exp/dritte824_1222/prediccion_8.txt" \
  "gs://normanbuck/exp/dritte824_1222/prediccion_9.txt" \
  .
```
...
PARAM <- list(
  experimento = "dritte824_1122_promedioSemillas",
  semillas = 1:18
  #envios_opt = 10000
)
setwd(sendero)

...
```{bash}
gsutil -m cp \
  "gs://normanbuck/exp/dritte824_1129null/prediccion_1.txt" \
  "gs://normanbuck/exp/dritte824_1129null/prediccion_10.txt" \
  "gs://normanbuck/exp/dritte824_1129null/prediccion_11.txt" \
  "gs://normanbuck/exp/dritte824_1129null/prediccion_12.txt" \
  "gs://normanbuck/exp/dritte824_1129null/prediccion_13.txt" \
  "gs://normanbuck/exp/dritte824_1129null/prediccion_14.txt" \
  "gs://normanbuck/exp/dritte824_1129null/prediccion_15.txt" \
  "gs://normanbuck/exp/dritte824_1129null/prediccion_16.txt" \
  "gs://normanbuck/exp/dritte824_1129null/prediccion_17.txt" \
  "gs://normanbuck/exp/dritte824_1129null/prediccion_18.txt" \
  "gs://normanbuck/exp/dritte824_1129null/prediccion_2.txt" \
  "gs://normanbuck/exp/dritte824_1129null/prediccion_3.txt" \
  "gs://normanbuck/exp/dritte824_1129null/prediccion_4.txt" \
  "gs://normanbuck/exp/dritte824_1129null/prediccion_5.txt" \
  "gs://normanbuck/exp/dritte824_1129null/prediccion_6.txt" \
  "gs://normanbuck/exp/dritte824_1129null/prediccion_7.txt" \
  "gs://normanbuck/exp/dritte824_1129null/prediccion_8.txt" \
  "gs://normanbuck/exp/dritte824_1129null/prediccion_9.txt" \
  .
```
...
experimento <- 'dritte824_1129null'
sendero <- paste0(sendero_base, experimento, '/') 
```

```{r biblioteca data.table}
library(data.table)
```
...
PARAM <- list(
  experimento = "dritte824_1129_nullSeeds",
  semillas = 1:18
  #envios_opt = 10000
)
setwd(sendero)

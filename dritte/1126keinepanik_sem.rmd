...
```{bash}
gsutil -m cp \
  "gs://normanbuck/exp/dritte824_1226keinePanic/prediccion_1.txt" \
  "gs://normanbuck/exp/dritte824_1226keinePanic/prediccion_10.txt" \
  "gs://normanbuck/exp/dritte824_1226keinePanic/prediccion_11.txt" \
  "gs://normanbuck/exp/dritte824_1226keinePanic/prediccion_12.txt" \
  "gs://normanbuck/exp/dritte824_1226keinePanic/prediccion_13.txt" \
  "gs://normanbuck/exp/dritte824_1226keinePanic/prediccion_14.txt" \
  "gs://normanbuck/exp/dritte824_1226keinePanic/prediccion_15.txt" \
  "gs://normanbuck/exp/dritte824_1226keinePanic/prediccion_16.txt" \
  "gs://normanbuck/exp/dritte824_1226keinePanic/prediccion_17.txt" \
  "gs://normanbuck/exp/dritte824_1226keinePanic/prediccion_18.txt" \
  "gs://normanbuck/exp/dritte824_1226keinePanic/prediccion_2.txt" \
  "gs://normanbuck/exp/dritte824_1226keinePanic/prediccion_3.txt" \
  "gs://normanbuck/exp/dritte824_1226keinePanic/prediccion_4.txt" \
  "gs://normanbuck/exp/dritte824_1226keinePanic/prediccion_5.txt" \
  "gs://normanbuck/exp/dritte824_1226keinePanic/prediccion_6.txt" \
  "gs://normanbuck/exp/dritte824_1226keinePanic/prediccion_7.txt" \
  "gs://normanbuck/exp/dritte824_1226keinePanic/prediccion_8.txt" \
  "gs://normanbuck/exp/dritte824_1226keinePanic/prediccion_9.txt" \
  .
```
...
experimento <- 'dritte824_1226keinePanic'
...
PARAM <- list(
  experimento = "dritte824_1126keinePanik_ps",
  semillas = 1:18
  #envios_opt = 10000
)
setwd(sendero)
